	...
	<div class="container">
		...
		<div>
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="./logoutAdmin.jsp">로그아웃</a></li>
				<li class="nav-item"><a class="nav-link" href="./updateAdmin.jsp">정보 수정</a></li>
				<li class="nav-item"><a class="nav-link" href="./memberList.jsp">회원 목록</a></li>
